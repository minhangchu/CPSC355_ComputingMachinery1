...
main:								// Where execution starts
	...
	define(i, w22)						// Define the name of w22 is variable i for loop
	...
	define(temp2, x26)					// Define the name of x26 is temp2
  	...
  	// Initialize variable
	mov	multiplicand, 	-16843010			// Initialize multiplicand value to -16843010
	mov	multiplier,	70				// Initialize multiplier value to 70
